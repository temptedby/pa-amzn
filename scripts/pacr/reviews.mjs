...
export const REVIEWS = [
  { id:'adam3914', name:'adam3914', stars:5, date:'December 2024', asin:'B07Y5GZP1T', typo:true,
  ...
  { id:'kevin', name:'Kevin', stars:5, date:'February 2026', asin:'B07Y5GZP1T',
    ...
    photo:`${L}/Photos_Mexico_Raw_Photos_Videos_Dec_2020__IMG_20201202_113009.jpg`,
    why:'he says JEANS; this is the clip on a denim waistband. The 08-11 card used khaki trousers and William caught it' },

  { id:'meda48', name:'meda48', stars:5, date:'February 2026', asin:'B07Y5GZP1T',
  ...
  { id:'prescillia', name:'Prescillia01', stars:5, date:'February 2026', asin:'B07Y5GZP1T',
  ...
  { id:'eddie-d', name:'Eddie D', stars:5, date:'July 2024', asin:'B097MGPCPC',
    ...
    photo:`${F}/hotos_Megan_Lindsay_Oaxaca__A7_08254.jpg`,
    why:'we own NO crowd or night-venue photography, so rather than dress a quiet daytime street up '
      + 'as a rave, the frame shows the thing his story turns on: the phone in a hand, attached' },

  { id:'ca-in-ca', name:'CA in CA', stars:5, date:'March 2024', asin:'B097MGPCPC',
  ...
  { id:'jarret-dodge', name:'Jarret Dodge', stars:5, date:'June 2023', asin:'B097MGPCPC',
    ...
    photo:`${F}/hotos_Megan_Lindsay_Oaxaca__A7_08215.jpg`,
    why:'no festival or concert photography exists in our library; this is the brightest going-out '
      + 'frame we own, belt bag and phone in hand. Honest adjacent, not a claimed venue' },

  { id:'mj', name:'MJ', stars:5, date:'August 2024', asin:'B0BLLJLSDP',
  ...
  { id:'courtney', name:'Courtney Robinson', stars:5, date:'March 2025', asin:'B0BLLJLSDP',
  ...
  { id:'ralisa', name:'Ralisa Watson', stars:5, date:'March 2025', asin:'B0BLLJLSDP', typo:true,
  ...
  { id:'treasure', name:'Treasure', stars:4, date:'November 2024', asin:'B07Y5GZP1T',
  ...
  { id:'david-guzman', name:'David Guzman', stars:5, date:'April 2026', asin:'B097MGPCPC',
    quote:'Best way to secure an iPhone or iPad. Perfect.',
    theme:'short and total',
    photo:`${L}/_Phone_Assured_Photos_Cozumel_April_9th__IMG_20210409_131551.jpg`,
    why:'the hardware itself, held, over open water' },

  { id:'amazon-ca-purse', name:'Amazon Customer', stars:5, date:'October 2025', asin:'B0BLLJLSDP',
  ...
  { id:'george-cameron', name:'George Cameron', stars:4, date:'February 2025', asin:'B0BLLJLSDP',
